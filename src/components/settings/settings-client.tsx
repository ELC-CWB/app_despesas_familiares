...
import { UserPlus, Users, Mail, Check, Crown, Loader2 } from "lucide-react";
...
export function SettingsClient({ profile, group, members, pendingInvites, myInvites, currentUserId }: SettingsClientProps) {
